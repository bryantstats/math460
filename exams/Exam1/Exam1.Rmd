...
Calculate the impurity of all possible splits to decide the best vertical first split for the following dataset.  Impurity can be measured by entropy or Gini-Index.
