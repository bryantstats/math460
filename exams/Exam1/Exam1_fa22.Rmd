...
_**Instruction**_:  You can scan your answers and submit it to Canvas.  You can also type your answers and submit the documents to Canvas. The solutions for the similar problems are provided at each problem. 

-------

#### Problem 1

Calculate the impurity of all possible splits to decide the best vertical first split for the following dataset.  Impurity can be measured by entropy or Gini-Index. A similar problem can be found at the example at the class slides ([Link](fa21_classification_tree2_original.pdf)).
