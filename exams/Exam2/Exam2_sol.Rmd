...
The decision boundary is as follows. (Red points are negatives).  See this note for how to draw this decision boundary: [Note](Adaboost_note2.pdf), or [this note](Adaboost_2024.pdf)
...
## Solution
a. The prediction of the first round (Pred1) is just the average of $y$ (Pred1 = $\bar{y} = \frac{1+0+2}{3}= 1$).
