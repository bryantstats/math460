...
- Describe the process of building a predictive model: Data partition, training model and validating/testing model. Explain the issue of overfitting. Explain model tuning. 
