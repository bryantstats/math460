...
**Dataset**: Your dataset should have at least 7 variables, at least 200 rows and be different from any dataset that have been used in the class. The target variable should be binary.

------------------------------------------------------------------------

## 1. Written Component (80%):

You are asked to complete a [RESEARCH PAPER]{.underline}. Your paper should have a **title**; an **abstract** and **references.** Your paper should also include the following sections.

------------------------------------------------------------------------

### 1.1. Introduction of Machine Learning and your problem
...
### 1.2. Predictive Modeling Explained.
...
-   Introduce and Explain the following models. For each model explain the given hyparameters in the parentheses and how the hyperparameters could affect model's performance. Discuss pros and cons of the models.
    ...
    -   Neural Networks (Number of layers, number of neurons, activation functions)
...
### 1.4. SAS Miner Implementation and Result.
