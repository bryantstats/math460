---
title: "Assignment 5: Handwritten Recognition with Ensemble Models"
format: html
editor: visual
---
...
_**What to do:**_  Train an ensemble model (Random forest, Adaboost or Gradient Boosting) to recognize three handwritten letters or numbers. Present your model and record the presentation using Zoom or any recording software.  In the presentation, 
...
- [Video Instruction](https://bryant.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=91c7ceb4-7949-48ee-adb3-af33010fc736)
