...
```{r echo = FALSE}
d = data.frame(i1 = c(5,3,4,3,1), i2 = c(3,1,3,3,5), i3 = c(4,2,4,1,5), i4 = c(4,3,3,4,2), i5 = c('???', 3,5,4,1))
row.names(d)= c('Alice', 'User 1','User 2','User 3','User 4')
names(d) = c("Item 1","Item 2","Item 3","Item 4","Item 5")
